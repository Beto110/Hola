...
#¿Qué ventajas tiene su diseño si mañana el gimnasio agrega nuevas métricas, como asistencia mensual o pagos realizados?
# El diseño permite agregar fácilmente nuevas métricas o atributos a la clase Socio sin afectar el código.

#¿Cómo cambiaría su solución si quisiera agregar un grupo de entrenamiento o equipo al que pertenecen los socios?
# Podría agregar un atributo `grupo_entrenamiento` a la clase Socio y una clase adicional `GrupoEntrenamiento` 
# para gestionar los grupos y sus socios.